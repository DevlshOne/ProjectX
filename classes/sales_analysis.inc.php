...
//             }
    ...
    function makeHTMLReport($stime, $etime, $campaign_code, $agent_cluster_id, $user_team_id, $combine_users, $user_group, $ignore_group, $vici_campaign_code = '', $ignore_arr = NULL, $vici_campaign_id = '') {
		...
		## GENERATE DATA FUNCTION MOVED TO API FILE
		include_once($this->basedir."api/sales_analysis_report.api.php");
		$obj = new API_Sales_Analysis_Report();
		
		
		list($agent_data_arr, $totals) = $obj->generateData($stime, $etime, $campaign_code, $agent_cluster_id, $user_team_id, $combine_users, $user_group, $ignore_group, $vici_campaign_code, $ignore_arr, $vici_campaign_id);
