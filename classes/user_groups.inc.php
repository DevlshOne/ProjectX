...
#                            $this->listMasterEntrys();
        ...
        function listEntrys()
        {
            ...
            <script>
                ...
                let usergroups_loading_flag = false;
            ...
            <form name="<?= $this->frm_name ?>" id="<?= $this->frm_name ?>" method="POST"
                  action="<?= $_SERVER['REQUEST_URI'] ?>#usergroupsarea" onsubmit="loadUsergroups();return false">
                <input type="hidden" name="searching_usergroups">
                <input type="hidden" name="<?= $this->order_prepend ?>orderby"
                       value="<?= htmlentities($this->orderby) ?>">
                <input type="hidden" name="<?= $this->order_prepend ?>orderdir"
                       value="<?= htmlentities($this->orderdir) ?>">
                <a name="usersarea"></a>
                            ...
                            <table border="0" width="100%">
                                <tr>
                                    ...
                                    <td width="150" align="center">PAGE SIZE: <select
                                                ...
                                                onchange="<?= $this->index_name ?>=0; loadUsergroups();return false">
                    ...
                    <tr>
                        <td>
                            <table border="0" id="usrgrp_search_table">
                                ...
                                <tr>
                                    <td><input type="text" name="s_name" size="10"
                                               value="<?= htmlentities($_REQUEST['s_name']) ?>"></td>
                                    <td><input type="text" name="s_group_name" size="10"
                                               value="<?= htmlentities($_REQUEST['s_group_name']) ?>"></td>
                                    <td>
                                        <?
                                    ...
                                    <td>
                                        <input type="button" value="Reset"
                                               onclick="resetUserGroupForm(this.form);loadUsergroups();">
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <td colspan="2">
                    <table border="0" width="100%" id="usergroup_table">
                        <tr>
                            ...
                            <th class="row2" align="center"><?= $this->getOrderLink('vici_cluster_id') ?>
                                Cluster</a></th>
...
//return;
            ...
            <form method="POST" action="<?= stripurl('') ?>" autocomplete="off"
                  onsubmit="checkUserGroupFrm(this); return false">
                            ...
                            <table border="0" align="center">
                                    ...
                                    <td>
                                        <?
                                            if ($id) {
                                                ...
                                                ?>
                                                <input type="button" value="EDIT IN VICIDIAL"
                                                       onclick="window.open('<?= $url ?>')"><?
                                            } else {
                                                ?>
                                                <input name="user_group" type="text" size="30" maxlength="20"
                                                       value="<?= htmlentities($row['user_group']) ?>"><?
                                            }
                                        ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input name="name" type="text" size="30"
                                               value="<?= htmlentities($row['name']) ?>"></td>
                                </tr>
