                        ...
                        <form id="agentstatfrm" method="POST" action="<?= stripurl() ?>" onsubmit="return genReport(this,'callstats')">
                            ...
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= makeClusterDD('s_source_cluster_id', $source_cluster_id, "", '', 1); ?>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= makeClusterDD('s_ignore_source_cluster_id', $ignore_source_cluster_id, "", '', 1); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th>User Team:</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= makeViciUserGroupDD('s_source_user_group[]', $_REQUEST['s_source_user_group'], "", '', 8, 1); ?>
                                    </td>
                                </tr>
