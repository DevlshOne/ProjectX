        ...
        <div class="block">
            ...
            <div class="block-content">
           		<form class="d-none d-sm-inline-block" method="POST" action="<?= stripurl('') ?>" onsubmit="return lookup_phone(this);">
                    ...
                    <input type="checkbox" id="search_area_clusters" name="search_areas[]" value="vici" />Search All Clusters<br />
                    <input type="checkbox" id="search_area_px" name="search_areas[]" value="px" />Search PX/LMT<br />
                    <input type="checkbox" id="search_area_listtool" name="search_areas[]" value="listtool" />Search List Tool
