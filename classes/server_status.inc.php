        ...
        <div class="block">
            <div class="block-header bg-primary-light">
                ...
                <div class="d-inline-block ml-2">
                    <button class="btn btn-sm" title="Total Users">
                        <i class="si si-user"></i>
                        <span class="badge badge-success badge-pill"><?= number_Format($total_users) ?></span>
                    </button>
                </div>
            </div>
                            ...
                            <td>
                                <table border="0" width="100%">
                                    ...
                                    if ($is_up) {
                                        ...
                                        <tr>
                                            <td colspan="2" align="center"><input type="button" value="View Users" onclick="$('#users_server_<?= $idx ?>').dialog({width: 700, height: 480, title: 'Users of <?= $servers[$idx]['name'] ?>' } );"></td>
                                        </tr>
                                        <?
                                    }
                                    ?>
