			...
			<td colspan="2">
				...
				<tr>
					...
					<td><?
						...
						echo makeTimebar("time_", 1, null,false,$timestamp);
				...
				<tr>
					...
					<td><?
						...
						echo $this->makeClusterDD("cluster_id", (isset($_REQUEST['cluster_id']))?$_REQUEST['cluster_id']:-1, '', "");
				...
				<tr>
					...
					<td><?
						...
						echo $this->makeClusterDD("verifier_cluster_id", (isset($_REQUEST['verifier_cluster_id']))?$_REQUEST['verifier_cluster_id']:-1, '', "");
