...
//echo $sql;
	...
	function makeReport(){
		...
		<tr>
			<td height="40" class="pad_left ui-widget-header">Summary Report</td>
		</tr>
		<tr>
			<td colspan="2">
				...
				<tr>
					<th colspan="2">
						...
						<span id="summary_submit_report_button">
		...
		if(isset($_POST['generate_report'])){
			...
			/*?><div style="border:1px dotted #999;padding:5px;margin:5px"><?*/
