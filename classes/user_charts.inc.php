    ...
    function makeReport()
    {
        ...
        <div class="block">
            ...
            <div class="block-header bg-primary-light">
                <h4 class="block-title">User Charts</h4>
            </div>
                ...
                <form method="POST" action="<?= stripurl() ?>" onsubmit="loadGraphImage(this);return false;">
                    ...
                    <table class="tightTable">
                        <tr>
                            <th>Time frame:</th>
                            <td>
                                <select class="form-control custom-select-sm" name="time_frame" onchange="toggleDateSearchMode(this.value)">
                        ...
                        <tr>
                            <th>Date:</th>
                            <td>
                                <?= makeTimebar("s_date_", 1, null, false, $stime, ""); ?>
                            </td>
                        </tr>
                        <tr>
                            <th>Total Mode:</th>
                            <td>
                                <select class="form-control custom-select-sm" name="max_mode">
                        ...
                        <tr>
                            <td colspan="2" class="input-group-sm">
                                <button type="submit" class="btn btn-sm btn-success" title="Generate Now">Generate</button>
                            </td>
                        </tr>
                    </table>
