...
//				newopts[0].value	= 0;
	...
	function listEntrys(){
		...
		<tr>
			<td><table border="0" id="usr_search_table">
			<tr>
		...
		<tr>
			<td colspan="2"><table border="0" width="100%" id="user_table">
			<tr>
				<th class="row2">&nbsp;</th>
...
//return;
		...
		// SHOW TABS IF EDITING A MANAGER
	...
	/**	if($id && $row['priv'] == 4){
		?><div id="user_tabs">
		<ul>
			<li><a href="#general" onclick="$('#dialog-modal-add-user').dialog('option', 'height', 360);">General</a></li>
			<li><a href="#features" onclick="$('#dialog-modal-add-user').dialog('option', 'height', 460);">Features</a></li>
		</ul><?
		}
