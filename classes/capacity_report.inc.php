    ...
    function makeHTMLReport()
    {
        ...
        <div class="block">
            <div class="block-header bg-primary-light">
                <h4 class="block-title">Dialer Capacity Report</h4>
                <button type="button" title="Refresh" class="btn btn-sm btn-info" onclick="loadSection('?area=capacity_report&no_script=1');">Refresh</button>
            </div>
            <div class="block-content">
                <div id="columnchart_material" style="width: 800px; height: 500px;"></div>
                <table id="capacity_report_table" border="0" width="500">
                    <thead>
                    <tr>
