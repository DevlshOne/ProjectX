<?php
    ...
    function connectCCIDB() {
        ...
        $db = mysqli_connect($_SESSION['site_config']['ccidb']['sqlhost'], $_SESSION['site_config']['ccidb']['sqllogin'], $_SESSION['site_config']['ccidb']['sqlpass'], $_SESSION['site_config']['ccidb']['sqldb']);
...
//		}
    ...
    function connectListDB() {
        ...
        $db = mysqli_connect($_SESSION['site_config']['listdb']['sqlhost'], $_SESSION['site_config']['listdb']['sqllogin'], $_SESSION['site_config']['listdb']['sqlpass'], $_SESSION['site_config']['listdb']['sqldb']);
    ...
    function connectOpenSipsDB($dbidx) {
        ...
        $db = mysqli_connect($_SESSION['site_config']['opensipsdb'][$dbidx]['sqlhost'], $_SESSION['site_config']['opensipsdb'][$dbidx]['sqllogin'], $_SESSION['site_config']['opensipsdb'][$dbidx]['sqlpass'], $_SESSION['site_config']['opensipsdb'][$dbidx]['sqldb']);
    ...
    function connectPXDB() {
        ...
        $db = mysqli_connect($_SESSION['site_config']['pxdb']['sqlhost'], $_SESSION['site_config']['pxdb']['sqllogin'], $_SESSION['site_config']['pxdb']['sqlpass'], $_SESSION['site_config']['pxdb']['sqldb']
...
//		}
    ...
    function connectViciDB($dbidx) {
        ...
        $db = mysqli_connect($_SESSION['site_config']['db'][$dbidx]['sqlhost'], $_SESSION['site_config']['db'][$dbidx]['sqllogin'], $_SESSION['site_config']['db'][$dbidx]['sqlpass'], $_SESSION['site_config']['db'][$dbidx]['sqldb']);
