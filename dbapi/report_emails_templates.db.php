...
class ReportEmailsTemplatesAPI{

	var $table = "report_emails_templates";


	function loadTemplates(){
		
		$rowarr = $_SESSION['dbapi']->fetchAllAssoc("SELECT * FROM `".$this->table."` ORDER BY report_id ASC, name ASC");
