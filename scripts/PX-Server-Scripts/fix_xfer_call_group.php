...
//exit;
	...
	$res = query("SELECT id, lead_tracking_id,agent_cluster_id FROM transfers WHERE call_group IS NULL",1);
...
//continue;
		...
		execSQL("UPDATE sales SET call_group='".addslashes($group)."' WHERE lead_tracking_id='".$xfer['lead_tracking_id']."' AND transfer_id='".$xfer['id']."'");
