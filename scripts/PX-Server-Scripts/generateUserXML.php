 ...
 *
 * *** OLD CODE, NOT UPDATED TO MYSQLI DUE TO LACK OF USE/AGE ***
 *
 *
 */
/** Everything is in one database now
        ...
        $vici_dbs = array(
                ...
                array("10.100.0.205", "ccidata", "cci", "MuW94uPe")
...
**/
	...
	$basedir = "/var/www/testsales/";

        $user_xml_file = $basedir."xmldata/users.xml";
        $dbhost ="10.100.0.205";
        $dbuser ="cci";
        $dbpass ="MuW94uPe";
        $dbname ="ccidata";
...
/***************************************************/
        ...
        require_once($basedir."utils/report_utils.php");
