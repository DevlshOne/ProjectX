 ...
 */
	...
	$old_version_number = "2.100";
	$new_version_number = "2.105";
...
/** THE REST SHOULD BE FINE, UNLESS THINGS DRASTICALLY CHANGE **/
	...
	$new_version_folder = "/var/www/html/download/dev/";
	$launch_to_folder = "/var/www/html/download/";
	...
	include_once("/var/www/html/dev/site_config.php");
